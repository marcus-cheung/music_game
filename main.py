...
def setupMain():
    ...
    playlist_buttons = [f"<button class='playlist' id='p{playlist['id']}' value='{playlist['id']}' onclick='add_playlist({playlist['id']})'>{playlist['name']}</button>" for playlist in playlist_infos]
