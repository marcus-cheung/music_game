...
def setupMain():
    ...
    socketio.emit("add_playlist", [f'<button class="playlist" id="{playlist["name"]}" name="checkbox" value="{playlist["id"]}">{playlist["name"]}</button>' for playlist in playlist_infos], room=request.sid)
